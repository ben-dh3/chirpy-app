...
export default function Home() {
  return (
    <main className="m-4 gap-20 flex flex-col justify-center items-center min-h-screen">
      <div className="space-y-4">
        <h1 className={`${nunito_sans.className} text-center text-4xl font-bold antialiased`}>Chirpy</h1>
        <p className="text-primary-400">Daily renewal with your self care songbird.</p>
      </div>
